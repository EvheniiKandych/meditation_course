...
export function Noise(): ReactNode {
  return (
    <section className="mb-20" aria-labelledby="noise-title">
      <h2 id="noise-title" className="font-heading text-3xl uppercase tracking-calm sm:text-4xl">
